...
# Convert product data into dictionary for quick access
product_dict = {product['asin']: product for product in product_data}
...
def recommend_items(user_id, top_n=5):
    ...
    cosine_similarities = cosine_similarity(tfidf_matrix, tfidf_vectorizer.transform([product_dict[product_id]['title'] for product_id in product_dict]))
